...
export default function Rules() {
  ...
  return (
    <Container>
      <Header>
        <BackButton onPress={handleNavStart}>
          <BackIcon name="arrow-back-ios" />
        </BackButton>
        <HeaderTitle>Regras</HeaderTitle>
      </Header>

      <ScrollTextRules contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <Paragraph style={{ marginBottom: 20 }}>
          ...
          Se acertar você vai ser enviado para uma página de sucesso, se errar,
